...
/** Simple INI file reader.
    ...
    <table>
        ...
        <tr><td>char        <td>No              <td>SimpleIniA
        <tr><td>char        <td>Yes             <td>SimpleIniCaseA
        <tr><td>wchar_t     <td>No              <td>SimpleIniW
        <tr><td>wchar_t     <td>Yes             <td>SimpleIniCaseW
    </table>
...
public:
    ...
    /** set of dependent string pointers. Note that these pointers are
        dependent on memory owned by SimpleIni.
    */
...
public:
    ...
    */
    ...
    /** Retrieve all section names. The list is returned as an STL vector of
        ...
        string data is stored in memory owned by SimpleIni. Ensure that the
        SimpleIni object is not destroyed or Reset() while these pointers
        are in use!
    ...
    /** Retrieve all unique key names in a section. The sort order of the
        ...
        NOTE! This structure contains only pointers to strings. The actual
        string data is stored in memory owned by SimpleIni. Ensure that the
        SimpleIni object is not destroyed or Reset() while these strings
        are in use!
    ...
    /** Retrieve all values for a specific key. This method can be used when
        ...
        owned by SimpleIni. Ensure that the SimpleIni object is not destroyed
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SimpleIniTempl(
    bool a_bIsUtf8,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
void
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::Reset()
{
    // remove all data
    delete[] m_pData;
    m_pData = NULL;
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::LoadFile(
    const char * a_pszFile
    )
{
    FILE * fp = NULL;
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::LoadData(
    const char *    a_pData,
    size_t          a_uDataLen
    )
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::FindFileComment(
    SI_CHAR *&      a_pData,
    bool            a_bCopyStrings
    )
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::FindEntry(
    SI_CHAR *&        a_pData,
    const SI_CHAR *&  a_pSection,
    const SI_CHAR *&  a_pKey,
    const SI_CHAR *&  a_pVal,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::IsMultiLineTag(
    const SI_CHAR * a_pVal
    ) const
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::IsMultiLineData(
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::IsNewLineChar(
    SI_CHAR a_c
    ) const
{
    return (a_c == '\n' || a_c == '\r');
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::LoadMultiLineText(
    SI_CHAR *&          a_pData,
    const SI_CHAR *&    a_pVal,
    const SI_CHAR *     a_pTagName,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::CopyString(
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::AddEntry(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    const SI_CHAR * a_pValue,
    const SI_CHAR * a_pComment,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
const SI_CHAR *
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetValue(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
long
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetLongValue(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    long            a_nDefault,
    bool *          a_pHasMultiple
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error 
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SetLongValue(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    long            a_nValue,
    const SI_CHAR * a_pComment,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
double
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetDoubleValue(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    double          a_nDefault,
    bool *          a_pHasMultiple
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error 
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SetDoubleValue(
	const SI_CHAR * a_pSection,
	const SI_CHAR * a_pKey,
	double          a_nValue,
	const SI_CHAR * a_pComment,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetBoolValue(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    bool            a_bDefault,
    bool *          a_pHasMultiple
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error 
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SetBoolValue(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    bool            a_bValue,
    const SI_CHAR * a_pComment,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetAllValues(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    TNamesDepend &  a_values
    ) const
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
int
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetSectionSize(
    const SI_CHAR * a_pSection
    ) const
{
    if (!a_pSection) {
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
const typename SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::TKeyVal *
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetSection(
    const SI_CHAR * a_pSection
    ) const
{
    if (a_pSection) {
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
void
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetAllSections(
    TNamesDepend & a_names
    ) const
{
    a_names.clear();
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::GetAllKeys(
    const SI_CHAR * a_pSection,
    TNamesDepend &  a_names
    ) const
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::SaveFile(
    const char *    a_pszFile,
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
SI_Error
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::Save(
    OutputWriter &  a_oOutput,
    bool            a_bAddSignature
    ) const
{
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::OutputMultiLineText(
    OutputWriter &  a_oOutput,
    Converter &     a_oConverter,
    const SI_CHAR * a_pText
    ) const
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::Delete(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    bool            a_bRemoveEmpty
    )
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
bool
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::DeleteValue(
    const SI_CHAR * a_pSection,
    const SI_CHAR * a_pKey,
    const SI_CHAR * a_pValue,
    bool            a_bRemoveEmpty
...
template<class SI_CHAR, class SI_STRLESS, class SI_CONVERTER>
void
SimpleIniTempl<SI_CHAR,SI_STRLESS,SI_CONVERTER>::DeleteString(
    const SI_CHAR * a_pString
    )
{
...
typedef SimpleIniTempl<char,
    SI_NoCase<char>,SI_ConvertA<char> >                 SimpleIniA;
typedef SimpleIniTempl<char,
    SI_Case<char>,SI_ConvertA<char> >                   SimpleIniCaseA;

#if defined(SI_CONVERT_ICU)
typedef SimpleIniTempl<UChar,
    SI_NoCase<UChar>,SI_ConvertW<UChar> >               SimpleIniW;
typedef SimpleIniTempl<UChar,
    SI_Case<UChar>,SI_ConvertW<UChar> >                 SimpleIniCaseW;
#else
typedef SimpleIniTempl<wchar_t,
    SI_NoCase<wchar_t>,SI_ConvertW<wchar_t> >           SimpleIniW;
typedef SimpleIniTempl<wchar_t,
    SI_Case<wchar_t>,SI_ConvertW<wchar_t> >             SimpleIniCaseW;
#endif

#ifdef _UNICODE
# define SimpleIni      SimpleIniW
# define SimpleIniCase  SimpleIniCaseW
# define SI_NEWLINE      SI_NEWLINE_W
#else // !_UNICODE
# define SimpleIni      SimpleIniA
# define SimpleIniCase  SimpleIniCaseA
